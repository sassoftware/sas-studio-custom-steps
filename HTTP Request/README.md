...
At the Input Options tab you specify  input parameters for the HTTP request.
   ...
   ||| **SAS Internal Viya API** - Specifies that the URL will point to Viya API at the current instance.<br><br>**Note:** In the URL field in the HTTP Request tab insert the URL without server information (e.g.: /referenceData/domains) |
