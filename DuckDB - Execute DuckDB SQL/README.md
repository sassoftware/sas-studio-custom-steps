...
* Version 1.0.2 (16JAN2026)
   * Renamed step from **DuckDB** to **DuckDB - Execute DuckDB SQL** given that there are now multiple DuckDB related steps in this repo
