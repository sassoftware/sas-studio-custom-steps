...
This custom step looks up all SAS Job Definitions in the current SAS Viya environment via the */jobDefinitions/definitions* API endpoint and then creates three output tables that contain all of the information collected.
