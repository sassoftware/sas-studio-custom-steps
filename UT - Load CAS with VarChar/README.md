...
* ### Options tab ###
   ...
   | --- | --- |                  
   | ![UT – Load CAS with VarChar](img/UT_Load_CAS_with_VarChar_tabOptions_standalone_mode.png) | ![UT – Load CAS with VarChar](img/UT_Load_CAS_with_VarChar_tabOptions_flow_mode.png) |
